...
#define BEZIER_ORDER_FOOT    15
#define NUM_INPUTS 16//(12 + 2*(BEZIER_ORDER_FOOT+1))
...
int main (void)
{
    ...
    while(1) {
        ...
        if (server.getParams(input_params,NUM_INPUTS)) {
            ...
            //  //for(int i = 0; i<2*(BEZIER_ORDER_FOOT+1);i+=2) {
            //  //  input_params[12+i] = -input_params[12+i];
            //  //}
...
;
                ...
                temp_product_2 = Jacobian_2*InverseMassMatrix_2*JacobianT_2;
